...
import (
	...
	"github.com/KielanL/dogs-project/ageDog"
	"github.com/KielanL/dogs-project/factsDog"
	"github.com/KielanL/dogs-project/imgDog"
	"github.com/KielanL/dogs-project/quizDog"
	"github.com/KielanL/dogs-project/weightDog"
)
...
func main() {
	...
	mux.HandleFunc("/obeseDoggo", weightDog.HandleRequest)
	...
	mux.HandleFunc("/dogImg", imgDog.HandleFuncDogImg)
